...
const STATES = {
  ...
  'Betragen lock — lines': (m) => { m.conduct = { ...conduct(44), lock: { active: true, since: iso(), lines: LINES, lineDays: [], apologies: [] } }; delete m.discipline; },
  'Betragen lock — apology': (m) => { m.conduct = { ...conduct(44), lock: { active: true, since: iso(), lines: LINES, lineDays: [day(-2), day(-1)], apologies: [] } }; delete m.discipline; },
  'Betragen lock — submitted': (m) => { m.conduct = { ...conduct(44), lock: { active: true, since: iso(), lines: LINES, lineDays: [day(-2), day(-1)], apologies: [{ date: day(), enc: fakeEnc }] } }; delete m.discipline; },
